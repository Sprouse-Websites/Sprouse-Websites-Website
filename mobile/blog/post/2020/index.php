<?php
$page_title = "2020 | Sprouse Websites Blog";
$url = "blog/post/2020.php";
...
<div class="w3-content" style="max-width:1400px">
	...
	<header class="w3-container w3-center w3-padding-32" style="background-color:#ABF;">
		<h1 style="margin:0pt!important;"><b><?php echo $blog; ?>: 2020 Posts</b></h1>
	</header>
...
<!-- Footer -->
<a disabled class="w3-button w3-black w3-disabled w3-padding-large w3-margin-bottom">Previous</a>
<a disabled class="w3-button w3-black w3-disabled w3-padding-large w3-margin-bottom">Next »</a>
<br>
<sub>Page 1 of 1</sub>
</main>
